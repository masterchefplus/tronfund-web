setTimeout(() => {
  var lang = window.localStorage.language, //window.navigator.language, // Check the Browser language
  translate; // Container of all translations

  // Call translations json file and populate translate variable
  jQuery.getJSON("js/translation/translations.json?v=8892", function(texts) {
      translate=texts;
